...
Android (arquitetura ARM), evitando o bug conhecido onde o
python-for-android acaba empacotando um binário compilado para
x86_64 em vez de compilar de verdade para o processador do celular
(erro: "dlopen failed: ... is for EM_X86_64 instead of EM_AARCH64").
"""
